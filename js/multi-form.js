        ...
        _setEvents: function () {
            ...
            return (
                ...
                t(".sw-btn-next", this.main).on("click", function (t) {
                    if(n.steps.length == 4){
                    let phoneNumberField = document.querySelector('.phone-number-input').value.replace(' ', '').length
                    let nameField = document.querySelector('.name-input').value.replace(' ', '').length
                    let adhaarNumberField = document.querySelector('.adhaar-card-number-input').value.replace(' ', '').length
                    let panNumberField = document.querySelector('.pan-number-input').value.replace(' ', '').length
                    let vehicleRegistrationField = document.querySelector('.vehicle-registration-input').value.replace(' ', '').length
                    let licenseField = document.querySelector('.license-input').value.replace(' ', '').length
                    let profileImageField = document.querySelector('.profile-image-input').files.length
                    let accountHolderNameField = document.querySelector('.account-holder-name-input').value.replace(' ', '').length
                    let accountHolderNumberField = document.querySelector('.account-holder-number-input').value.replace(' ', '').length
                    let ifscCodeField = document.querySelector('.ifsc-code-input').value.replace(' ', '').length
                    let branchNameField = document.querySelector('.branch-name-input').value.replace(' ', '').length
                    let upiIdCodeField = document.querySelector('.upi-id-input').value.replace(' ', '').length

                    if(phoneNumberField != 10){
                        new Toast({
                    ...
                    if(n.pages[0].style.display=="none")
                    if(nameField==0 || adhaarNumberField==0 || panNumberField==0 || vehicleRegistrationField==0 || licenseField==0||profileImageField==0){
                        new Toast({
                    ...
                    if(n.pages[1].style.display=="none")
                    if(accountHolderNameField==0 || accountHolderNumberField==0 || ifscCodeField==0 || branchNameField==0 || upiIdCodeField==0){
                        new Toast({
                            message: 'Please Fill Out All Fields',
                            type: 'danger'
                          });
                    ...
                    if(n.pages[2].style.display=="none"){
                        console.log('finished')
                    }
            //     }else if(n.steps.length == 3){
            //         let phoneNumberField = n.pages[0].children[0].children[0].children[0].value.replace(' ', '').length
            //         let nameField = n.pages[1].children[0].children[0].children[0].value.replace(' ', '').length
            //         let adhaarNumberField = n.pages[1].children[0].children[1].children[0].value.replace(' ', '').length
            //         let panNumberField = n.pages[1].children[1].children[0].children[0].value.replace(' ', '').length
            //         let vehicleRegistrationField = n.pages[1].children[1].children[1].children[0].value.replace(' ', '').length
            //         let licenseField = n.pages[1].children[2].children[0].children[0].value.replace(' ', '').length
            //  //       let profileImageField = n.pages[1].children[2].children[1].children[0].files.length
            //         let accountHolderNameField = n.pages[2].children[0].children[0].children[0].value.replace(' ', '').length
            //         let accountHolderNumberField = n.pages[2].children[0].children[1].children[0].value.replace(' ', '').length
            //         let ifscCodeField = n.pages[2].children[1].children[0].children[0].value.replace(' ', '').length
            //         let branchNameField = n.pages[2].children[1].children[1].children[0].value.replace(' ', '').length
            //         let upiIdCodeField = n.pages[2].children[2].children[0].children[0].value.replace(' ', '').length
            ...
            //         }
            //         if(n.pages[0].style.display=="none")
            //         if(nameField==0 || adhaarNumberField==0 || panNumberField==0 || vehicleRegistrationField==0 || licenseField==0){
            //             new Toast({
            //                 message: 'Please Fill Out All Fields',
            //                 type: 'danger'
            //               });
            ...
            //         }
            //     }{
                    // let phoneNumberField = document.querySelector('.phone-number-shop-input').value.replace(' ', '').length
                    // if(phoneNumberField != 10){
                    //     new Toast({
                    //         message: 'Phone Number Should Contain 10 Numbers',
                    //         type: 'danger'
